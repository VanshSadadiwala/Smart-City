...
function OfficerComplaintDetails() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.error("Officer Complaint Details Error:", err);
  ...
  const handleAssign = async () => {
    ...
    if (complaint.assignedTo && selectedWorker === complaint.assignedTo._id) {
      return;
    }
    ...
    try {
      ...
      setSuccess(response.data.message || "Complaint assigned successfully.");

      // Scroll to top so success message is immediately visible
      window.scrollTo({
        top: 0,
        behavior: "smooth",
      });
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-2">
            Review complaint information and manage assignment.
          </p>
        </div>
              ...
              <button
                ...
                disabled={
                  ...
                  (complaint.assignedTo &&
                    selectedWorker === complaint.assignedTo._id)
                }
